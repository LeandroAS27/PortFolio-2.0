...
const About:React.FC = () => {
    ...
    return(
        ...
        id="Sobre" 
        ref={ref}
        className="bg-[#dedede] dark:bg-[#1f1d1d] min-h-screen w-full flex justify-center px-6 pt-32">
            <motion.div 
            initial={{ opacity: 0, y:50 }}
            animate={inView ? { opacity: 1, y:0 } : {}}
            transition={{ duration: 0.9, ease: "easeOut" }}
            className="flex flex-col justify-center items-center w-3/4">
                <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-center text-black dark:text-white">Sobre mim</h1>
                <p className="text-sm sm:text-base leading-relaxed mb-4 text-black dark:text-white">
